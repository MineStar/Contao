...
package de.minestar.contao.commands.contao;
...
public class cmdContao extends AbstractSuperCommand {

    public cmdContao(String syntax, String arguments, String node, AbstractCommand... subCommands) {
